"""
Support remediation effectiveness for migration business logic.
...
class RemediationEffectivenessRecord:
    """Encapsulates remediation effectiveness record behavior for migration workflows."""
...
def build_remediation_effectiveness_report(
    ...
    """Build remediation effectiveness report for the migration workflow."""
