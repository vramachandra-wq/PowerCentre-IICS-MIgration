"""
Support migration service for migration business logic.
...
class EnterpriseMigrationPipeline:
    """Encapsulates enterprise migration pipeline behavior for migration workflows."""
    ...
    def run(self, persist_to_mysql: bool = False) -> dict[str, Any]:
        """Run migration data using the provided persist_to_mysql."""
