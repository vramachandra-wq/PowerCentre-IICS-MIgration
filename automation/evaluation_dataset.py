"""
Support evaluation dataset for automation data and validation workflows.
...
class EvaluationDatasetBuilder:
    """Encapsulates evaluation dataset builder behavior for migration workflows."""
    ...
    def build_canonical_dataset(self, objects: Iterable[CanonicalEvaluationObject]) -> list[dict[str, object]]:
        """Build canonical dataset using the provided objects."""
    ...
    def write(
        ...
        """Handle write using the provided dataset and canonical_dataset."""
