"""
Support validation summary for automation data and validation workflows.
...
class ValidationSummaryBuilder:
    """Encapsulates validation summary builder behavior for migration workflows."""
