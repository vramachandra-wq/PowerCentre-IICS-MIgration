"""
Support response parser for automation data and validation workflows.
...
class RecommendationResponseParser:
    ...
    def _payload(content: str | dict[str, Any]) -> dict[str, Any]:
        """Handle payload using the provided content."""
    ...
    def _normalize_priority(cls, value: str) -> str:
        """Normalize priority using the provided value."""
    ...
    def _sanitize_text(cls, value: str) -> str:
        """Handle sanitize text using the provided value."""
