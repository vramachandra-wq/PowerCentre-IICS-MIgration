"""
Support consolidated findings for automation data and validation workflows.
...
class ConsolidatedFindingsBuilder:
    """Encapsulates consolidated findings builder behavior for migration workflows."""
    ...
    def build(self, records: Iterable[EvaluationMatrixRecord]) -> dict[str, object]:
        """Build migration data using the provided records."""
    ...
    def write(self, findings: dict[str, object]) -> Path:
        """Handle write using the provided findings."""
    ...
    def _most_common_issue(rows: list[dict[str, str]], token: str) -> str:
        """Handle most common issue using the provided rows and token."""
    ...
    def _most_common_transformation_issue(rows: list[dict[str, str]]) -> str:
        """Handle most common transformation issue using the provided rows."""
    ...
    def _mapping_by_max(rows: list[EvaluationMatrixRecord], field: str) -> str:
        """Handle mapping by max using the provided rows and field."""
    ...
    def _mapping_by_min(rows: list[EvaluationMatrixRecord], field: str) -> str:
        """Handle mapping by min using the provided rows and field."""
